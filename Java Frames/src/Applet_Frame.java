    	 ...
    	 f.addWindowListener(new WindowAdapter()
       	 {
       		 ...
       		 {
       			 //f.setVisible(false);//will close the program but remains in memory
       			 f.dispose();//close only given window i.e of f object frame
       			 //System.exit(0); // will close all frame at a time
       	     }
    	});
